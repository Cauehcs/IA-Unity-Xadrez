...
public class InputController : MonoBehaviour
{
    ...
    private void Update() {
        ...
        if(Input.GetButtonDown("Cancel")) returnClicked(null, null);

    }

    public void Promotion(string namePiece){

        StateMachineController.instance.taskHolder.SetResult(namePiece);
